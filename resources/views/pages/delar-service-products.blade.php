...
@section($slug.'/'.$service_id) active @endsection
           ...
           <div class="row">  
                <div class="col-lg-12 text-center"> 
                    <div class="bread-text wow fadeInUp">  
                          <h2>ডিলার পণ্যসমূহ </h2>
                          <h4><a href="{{ url('/') }}">হোম</a><i class="fa fa-arrow-circle-right" aria-hidden="true"></i>>ডিলার পণ্যসমূহ </h4>
                    </div>
                </div>       
           </div>
    </div>
            ...
            <div class="col-lg-9">
               ...
               <div class="row  dealer-product-top">
                   @forelse ($products as $product)         
                    ...
                    @empty 
                    <strong class="text-danger text-center">দুঃখিত !! এই ডিলারের পণ্যের অন্তর্ভুক্ত কোনো পণ্য পাওয়া যায়নি</strong>
                  @endforelse
